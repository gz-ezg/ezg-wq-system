        ...
        <van-row style="padding-bottom:1.75rem">
            <van-nav-bar title="普通外勤打卡" />
                ...
                <van-row>
                    ...
                    <van-row><van-col span="4" offset="4" style="font-size:0.3rem">工单内容：</van-col><van-row><van-col span="12" style="font-size:12px">{{clockDetail.productname}}</van-col></van-row></van-row>
